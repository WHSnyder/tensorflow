...
#include "tensorflow/lite/delegates/gpu/metal_delegate_pyexposure.h"
...
TfLiteDelegate* tflite_plugin_create_delegate(char** options_keys,
  ...
  printf("Starting metal delegate setup\n");
  //auto opts = TfLGpuDelegateOptionsDefault();

  TfLiteDelegate* ptr = TFLGpuDelegateCreate(nullptr);
